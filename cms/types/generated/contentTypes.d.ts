...
export interface ApiLandingSettingLandingSetting
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  collectionName: 'ukish_orders';
  info: {
    description: '\u0417\u0430\u044F\u0432\u043A\u0438 \u0438\u0437 \u043A\u043E\u0440\u0437\u0438\u043D\u044B \u0441\u0430\u0439\u0442\u0430';
    displayName: '\u0417\u0430\u043A\u0430\u0437\u044B';
    pluralName: 'orders';
    singularName: 'order';
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  collectionName: 'ukish_products';
  info: {
    description: '\u041A\u0430\u0442\u0430\u043B\u043E\u0433 \u043C\u0430\u0442\u0440\u0430\u0441\u043E\u0432 UKISH';
    displayName: '\u0422\u043E\u0432\u0430\u0440\u044B';
    pluralName: 'products';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u041F\u0440\u0435\u043C\u0438\u0443\u043C'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.DefaultTo<'\u0421\u0440\u0435\u0434\u043D\u0435\u0439 \u0436\u0435\u0441\u0442\u043A\u043E\u0441\u0442\u0438'>;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  collectionName: 'ukish_reviews';
  info: {
    description: '\u041E\u0442\u0437\u044B\u0432\u044B \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432 \u0434\u043B\u044F \u0433\u043B\u0430\u0432\u043D\u043E\u0439 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B';
    displayName: '\u041E\u0442\u0437\u044B\u0432\u044B';
    pluralName: 'reviews';
    singularName: 'review';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::landing-setting.landing-setting': ApiLandingSettingLandingSetting;
